...
<body>
<form id="submitForm" name="submitForm" action="<?php echo U('admin/appfield/appfield_submit');?>" method="post" enctype="multipart/form-data">
	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<input type="hidden" name="app_id" value="<?php echo ($appList["app_id"]); ?>" id="id"/>
				<tr>
					<td class="ui_text_rt">应用领域名称</td>
					<td class="ui_text_lt">
						<input type="text" name="app_name" value="<?php echo ($appList["app_name"]); ?>" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
