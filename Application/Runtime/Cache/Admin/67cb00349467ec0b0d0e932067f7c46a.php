...
<body>
<form id="submitForm" name="submitForm" action="<?php echo U('admin/prodparam/prodparam_add');?>" method="post" enctype="multipart/form-data">
	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					<td class="ui_text_rt">
						<label for="prod-select">产品选择</label>
				  </td>
					<td class="ui_text_lt">
						<select id="prod-select" name="product_id">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" name="param_name" value=" " class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">产品参数描述 </td>
					<td class="ui_text_lt">
						<input type="text" name="param_desc" value=" " class="ui_input_txt02"/>
					</td>
				</tr>
