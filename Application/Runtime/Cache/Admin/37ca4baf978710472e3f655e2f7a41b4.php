...
<body>
	<form id="submitForm" name="submitForm" action="<?php echo U('admin/company/company_edit');?>" method="post">
				...
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						<tr>
							...
							<td class="ui_text_lt">
								<input type="text" name="name" value="<?php echo ($company["name"]); ?>" class="ui_input_txt02"/>
							</td>
						</tr>
						<tr>
							<td class="ui_text_rt">备案编号</td>
							<td class="ui_text_lt">
								<input type="text" name="icp" value="<?php echo ($company["icp"]); ?>" class="ui_input_txt02"/>
							</td>
						</tr>
						<tr>
							<td class="ui_text_rt">联系电话</td>
							<td class="ui_text_lt">
								<input type="text" name="tel" value="<?php echo ($company["tel"]); ?>" class="ui_input_txt02"/>
							</td>
						</tr>
						<tr>
							<td class="ui_text_rt">联系地址</td>
							<td class="ui_text_lt">
								<input type="text" name="address" value="<?php echo ($company["address"]); ?>" class="ui_input_txt02"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="ui_text_lt">
								<textarea rows="5" cols="100" name="description" value=""> <?php echo ($company["description"]); ?> </textarea>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
