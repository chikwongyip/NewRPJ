...
<body>
<form id="submitForm" name="submitForm" action="<?php echo U('admin/prodparam/prodparam_submit');?>" method="post" enctype="multipart/form-data">
	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<input type="hidden" name="param_id" value="<?php echo ($param[0]["param_id"]); ?>" id="id"/>
				<input type="hidden" name="product_id" value="<?php echo ($param[0]["product_id"]); ?>" id="id"/>
				<tr>
					<td class="ui_text_rt">产品名称</td>
					<td class="ui_text_lt">
						<input type="text" name="product_name" value="<?php echo ($param[0]["product_name"]); ?>" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">产品参数名称</td>
					<td class="ui_text_lt">
						<input type="text" name="param_name" value="<?php echo ($param[0]["param_name"]); ?>" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">产品参数描述</td>
					<td class="ui_text_lt">
						<input type="text" name="param_desc" value="<?php echo ($param[0]["param_desc"]); ?>" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
