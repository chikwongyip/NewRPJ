...
<body>
<form id="submitForm" name="submitForm" action="<?php echo U('admin/category/category_submit');?>" method="post" enctype="multipart/form-data">
	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<input type="hidden" name="category_id" value="<?php echo ($item["category_id"]); ?>" id="id"/>
				<tr>
					<td class="ui_text_rt">产品类型名称</td>
					<td class="ui_text_lt">
						<input type="text" name="category_name" value="<?php echo ($item["category_name"]); ?>" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">类别图片</td>
					<td class="ui_text_lt">
						<input type="file" name="category_image" size="35" />
						<label for="description">分辨率882*280</label>
					</td>
				</tr>
				<!-- <tr>
