...
<body>
<form id="submitForm" name="submitForm" action="<?php echo U('admin/news/news_submit');?>" method="post" enctype="multipart/form-data">
	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<input type="hidden" name="news_id" value="<?php echo ($news_list["news_id"]); ?>" id="news_id"/>
				<tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="checkbox" name="is_hot" value="X" checked="<?php echo ($new_list["is_hot"]); ?>" />
					</td>
				</tr>
				<tr>
