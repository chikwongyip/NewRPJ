...
<body>
<form id="submitForm" name="submitForm" action="<?php echo U('admin/prodatt/prodatt_submit');?>" method="post" enctype="multipart/form-data">
	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<input type="hidden" name="att_id" value="<?php echo ($prodAtt["att_id"]); ?>" id="id"/>
				<tr>
