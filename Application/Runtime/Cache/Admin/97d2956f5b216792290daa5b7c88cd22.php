...
<body>
<form id="submitForm" name="submitForm" action="<?php echo U('admin/category/category_add');?>" method="post" enctype="multipart/form-data">
	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					<td class="ui_text_rt">类别名称</td>
					<td class="ui_text_lt">
						<input type="text" name="category_name" value=" " class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
