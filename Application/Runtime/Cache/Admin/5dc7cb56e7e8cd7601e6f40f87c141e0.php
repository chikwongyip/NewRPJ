...
<script type="text/javascript">
	var addURL = "<?php echo U('admin/news/news_add');?>"
	var listURL = "<?php echo U('admin/news/news_list');?>"
...
//	 			alert(fyXqCode);
	...
	function del(fyID){
		...
		if(confirm("您确定要删除吗？")){
			...
			var url = "<?php echo U('admin/news/news_del');?>?news_id="+fyID;
				...
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<?php if(is_array($news_list)): foreach($news_list as $key=>$list): ?><tr>
								<td><input type="checkbox" name="is_hot" value="X" class="acb" checked="{if($list.is_hot!=null)<?php echo ($list["is_hot"]); ?>}" /></td>
								<td><?php echo ($list["news_title"]); ?></td>
								<td><?php echo ($list["news_content"]); ?></td>
								<td>
									<a href="<?php echo U('admin/news/news_edit',array('news_id'=>$list[news_id]));?>" class="edit">编辑</a>
									<a href="javascript:del(<?php echo ($list["news_id"]); ?>);">删除</a>
								</td>
