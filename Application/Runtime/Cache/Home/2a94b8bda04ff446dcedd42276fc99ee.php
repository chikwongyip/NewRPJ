...
<head>
	...
	<title>Picaboo - Responsive Bootstrap 4 eCommerce Template</title>
		    ...
		    <div class="container">
		        <div class="row">
		            ...
		            <div class="col-md-8 col-lg-6">
		                <div class="hero-slider owl-carousel">
                            <!--Single Slider Start-->
                            <div class="single-slider" style="background-image: url(/NewRPJ/Public/img/slider/home1-slider-1.jpg)">
                            ...
                            <!--Single Slider End-->
                            <!--Single Slider Start-->
                            <div class="single-slider" style="background-image: url(/NewRPJ/Public/img/slider/home1-slider-2.jpg)">
                                <div class="hero-slider-content">
		                        ...
		                        <div class="item-listcategories">
		                            ...
		                            <div class="list-categories">
		                                ...
		                                <div class="thumb-category">
		                                    <a href="shop.html"><img src="/NewRPJ/Public/img/product-thumb/product-thumb1.jpg" alt=""></a>
		                                </div>
		                            </div>
		                            ...
		                            <div class="list-categories">
		                                ...
		                                <div class="thumb-category">
		                                    <a href="shop.html"><img src="/NewRPJ/Public/img/product-thumb/product-thumb2.jpg" alt=""></a>
		                                </div>
		                            </div>
		                            <!--Single List Categories End-->
		                            <!--Single List Categories Start-->
		                            <div class="list-categories">
		                                ...
		                                <div class="thumb-category">
		                                    <a href="shop.html"><img src="/NewRPJ/Public/img/product-thumb/product-thumb3.jpg" alt=""></a>
		                                </div>
		                            </div>
		                            <!--Single List Categories End-->
		                        </div>
		        ...
		        <div class="banner-slide mt-30">
		            <div class="banner-inner">
		                <a href="#"><img class="d-lg-block d-md-block d-none" src="/NewRPJ/Public/img/banner/slider-banner.jpg" alt=""> <img class="d-block d-md-none d-lg-none" src="img/banner/slider-banner1.png" alt=""></a>
		            </div>
		        </div>
		    </div>
		</div>
		            ...
		            <div class="row">
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="single-banner-item mb-20">
                                <div class="banner-inner">
                                    <a href="#"><img src="/NewRPJ/Public/img/offer/offer1.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="single-banner-item mb-20">
                                <div class="banner-inner">
                                    <a href="#"><img src="/NewRPJ/Public/img/offer/offer2.jpg" alt=""></a>
                                </div>
                                <div class="banner-content">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="single-banner-item mb-20">
                                <div class="banner-inner">
                                    <a href="#"><img src="/NewRPJ/Public/img/offer/offer3.jpg" alt=""></a>
                                </div>
                                <div class="banner-content">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="single-banner-item mb-20">
                                <div class="banner-inner">
                                    <a href="#"><img src="/NewRPJ/Public/img/offer/offer4.jpg" alt=""></a>
                                </div>
                                <div class="banner-content">
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            ...
                                            <img class="hover-img" src="/NewRPJ/Public/img/product/product9.jpg" alt="">
                                        </a>
                                        <span class="sticker">New</span>
                                        <div class="product-action">
                                            <ul>
		...
		<div class="banner-area mt-80">
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                <div class="banner-inner">
                            <a href="#"><img src="/NewRPJ/Public/img/banner/offer-banner1.jpg" alt=""></a>
                        </div>
		            </div>
		        </div>
		    </div>
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                ...
                                                <img class="hover-img" src="/NewRPJ/Public/img/product/product8.jpg" alt="">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="product-action">
                                                <ul>
		        ...
		        <div class="cate-product-wrapper">
		           <div class="row">
                        ...
                        <div class="col-md-12 col-lg-9">
                            ...
                            <div class="banner-block-content">
                                <div class="banner-inner">
                                    <a href="#"><img src="/NewRPJ/Public/img/banner/product-banner2.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
		        ...
		        <div class="cate-product-wrapper">
		           <div class="row">
                        ...
                        <div class="col-md-12 col-lg-9">
                            ...
                            <div class="banner-block-content">
                                <div class="banner-inner">
                                    <a href="#"><img src="/NewRPJ/Public/img/banner/product-banner3.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
		        ...
		        <div class="cate-product-wrapper">
		           <div class="row">
                        ...
                        <div class="col-md-12 col-lg-9">
                            ...
                            <div class="banner-block-content">
                                <div class="banner-inner">
                                    <a href="#"><img src="/NewRPJ/Public/img/banner/product-banner4.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
		            ...
		            <div class="col-12">
		                <div class="brand-active owl-carousel">
		                    ...
		                    <div class="single-brand">
		                      <a href="#"><img src="/NewRPJ/Public/img/brand/brand1.jpg" alt=""></a>
		                    </div>
		                    <!--Single Brand End-->
		                    <!--Single Brand Start-->
		                    <div class="single-brand">
		                      <a href="#"><img src="/NewRPJ/Public/img/brand/brand2.jpg" alt=""></a>
		                    </div>
		                    <!--Single Brand End-->
		                    <!--Single Brand Start-->
		                    <div class="single-brand">
		                      <a href="#"><img src="/NewRPJ/Public/img/brand/brand3.jpg" alt=""></a>
		                    </div>
		                    <!--Single Brand End-->
		                    <!--Single Brand Start-->
		                    <div class="single-brand">
		                      <a href="#"><img src="/NewRPJ/Public/img/brand/brand4.jpg" alt=""></a>
		                    </div>
		                    <!--Single Brand End-->
		                    <!--Single Brand Start-->
		                    <div class="single-brand">
		                      <a href="#"><img src="/NewRPJ/Public/img/brand/brand5.jpg" alt=""></a>
		                    </div>
		                    <!--Single Brand End-->
		                    <!--Single Brand Start-->
		                    <div class="single-brand">
                  ...
                  <div class="col-md-5">
                      ...
                      <div class="tab-content product-details-large" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="single-slide3" role="tabpanel" aria-labelledby="single-slide-tab-3">
                            <!--Single Product Image Start-->
                            <div class="single-product-img img-full">
                              <img src="/NewRPJ/Public/mg/single-product/large/large3.jpg" alt="">
                            </div>
                            <!--Single Product Image End-->
                        </div>
