...
<html>
	...
	<head>
		...
		<link href="/NewRPJ/Public/css/Site.css" rel="stylesheet" type="text/css" />
		<link href="/NewRPJ/Public/css/zy.layout.css" rel="stylesheet" />
		<link href="/NewRPJ/Public/css/zy.form.css" rel="stylesheet" />
		<link href="/NewRPJ/Public/css/font-awesome.min.css" rel="stylesheet" />
		<style type="text/css">
			...
			.headeruserface {
				background-image: url('/NewRPJ/Public/content/resources/images/logo.png');
				width: 40px;
				height: 40px;
				background-color: white;
		...
		<link href="/NewRPJ/Public/css/zy.menu.css" rel="stylesheet" />
	</head>
	...
	<body>
		...
		<script src="/NewRPJ/Public/js/jquery-1.7.2.min.js" type="text/javascript"></script>
		<script src="/NewRPJ/Public/js/plugs/Jqueryplugs.js" type="text/javascript"></script>
		<script src="/NewRPJ/Public/js/_layout.js"></script>
